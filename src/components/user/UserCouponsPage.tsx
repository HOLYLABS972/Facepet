...
import { addPointsToCategory, getUserPoints, deductPointsFromCategory } from '@/src/lib/supabase/database/points';
import { purchaseCoupon, getActiveUserCoupons, getCouponHistory, markCouponAsUsed, UserCoupon } from '@/src/lib/supabase/database/coupons';
